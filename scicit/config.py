...
class Config:
    def __init__(self, credentials_f=None, project_id=None, dataset_id=None):
        ...
        self.project_id = project_id if project_id else self.config_dict["project_id"]
        self.dataset_id = dataset_id if dataset_id else self.config_dict["dataset_id"]
    ...
    def table_ref(self, table_id, client=None):
        ...
        if not client:
            client = self.client()
        return client.dataset(dataset_id=self.dataset_id).table(table_id=table_id)
