...
parallel split -l100000 "$1/tls214_part0{}.txt" "$1/small_chunks/tls214_part0{}_sub-" ::: 1 2 3 4 5
echo "SPLIT: DONE"
for file in $(find "$1"/small_chunks/tls214_part0*_sub-*);
  do mv "$file" "$file".txt;
done
#python3 ./bin/rename-tls214.py "$1"/small_chunks/ -> deprecated
echo "RENAME: DONE"
